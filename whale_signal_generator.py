...
def cleanup_old_reports(current_report_path: str) -> None:
    """
    現在生成したレポート以外の古い whale_signal_*.md を削除する。
    ファイル名が whale_signal_YYYYMMDD.md の形式に厳密一致するものだけを対象にし、
    ...
    pattern = re.compile(r"^whale_signal_\d{8}\.md$")
